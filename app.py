...
.thrift-header { background: linear-gradient(160deg, #0a0a0a 0%, #141410 40%, #1a1a12 100%); border-bottom: 1px solid #2a2618; padding: 48px 0 36px; text-align: center; margin-bottom: 40px; position: relative; }
...
with col_left:
    ...
    price_val = st.number_input("Price (₹)", min_value=0, value=500, step=50)
